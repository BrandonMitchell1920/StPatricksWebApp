 ...
 * Description: These are several functions that I use in multiple places for
 *              validation.  The site header is also defined here.
 */
...
// Returns a bool indicating if the lot value is valid
function validLot($lot)
{
    return is_numeric($lot) && $lot >= 1 && $lot <= 4;
}

// Returns a bool indicating if the plot value is valid
